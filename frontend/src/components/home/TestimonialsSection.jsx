...
const testimonials = [
  { name: 'Priya Sharma', city: 'Mumbai', rating: 5, avatar: 'PS', color: 'bg-red-500', text: 'Absolutely love TECAISHOP! The quality of clothes is amazing and they arrived within 2 days. The checkout experience with Razorpay was super smooth. Will definitely shop again!' },
  ...
  { name: 'Kavya Nair', city: 'Bangalore', rating: 5, avatar: 'KN', color: 'bg-red-500', text: 'The floral wrap dress I bought got so many compliments! Fast delivery, beautiful packaging, and the quality is better than expected. TECAISHOP is now my go-to fashion destination.' },
...
export default function TestimonialsSection() {
  return (
    <section className="py-16 bg-gradient-to-br from-red-50 via-red-50 to-white">
      <div className="max-w-7xl mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          <h2 className="font-display text-4xl font-bold text-gray-900 mb-3">What Our Customers Say</h2>
          <p className="text-gray-500">Join 50,000+ happy shoppers who love TECAISHOP</p>
