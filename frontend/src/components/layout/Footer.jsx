    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm mb-6">
              ...
              <div className="flex items-center gap-2"><FiMail className="w-4 h-4 text-red-400" /><a href="mailto:hello@TECAISHOP.com" className="hover:text-red-400">hello@TECAISHOP.com</a></div>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <button className="bg-gradient-to-r from-red-600 to-red-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity">Go</button>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm">© 2024 TECAISHOP. All rights reserved. Made with ❤️ in India.</p>
         <a
  href="https://tecai.in/"
  target="_blank"
...
>
  <span>Developed by Tecai</span>
  <img
    src="https://tecai.in/techai.png"
    className="h-6"
    alt="Tecai Logo"
  />
</a>
