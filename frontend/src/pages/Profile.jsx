    ...
    <div className="pt-28 min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm mb-6 flex items-center gap-5">
          <div className="w-20 h-20 bg-gradient-to-r from-red-500 to-red-500 rounded-full flex items-center justify-center text-white text-3xl font-bold">
        ...
        <div className="flex gap-1 bg-white rounded-2xl p-1 shadow-sm mb-6">
          {TABS.map(tab => (
            <button key={tab} onClick={() => setActiveTab(tab)}
              className={`flex-1 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === tab ? 'bg-gradient-to-r from-red-600 to-red-600 text-white shadow-md' : 'text-gray-500 hover:text-gray-700'}`}>
              {tab}
            </button>
          ))}
        </div>
