            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`p-4 rounded-xl border-2 transition-all h-14 w-14 flex items-center justify-center ${
                  inWishlist ? 'border-red-500 bg-red-50 text-red-500' : 'border-gray-200 text-gray-500 hover:border-red-300 hover:text-red-500'
                }`}
              >
                <FiHeart className={`w-5 h-5 ${inWishlist ? 'fill-current' : ''}`} />
              </button>
                    ...
                    {reviews.map(review => (
                      <div key={review._id} className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
