                      ...
                      <div className="px-5 py-4">
                                ...
                                {editingType[cat._id]?.oldType === type ? (
                                  <div className="flex items-center gap-2 flex-1">
                                    <input
                                      ...
                                      className="flex-1 text-xs border border-red-300 rounded-lg px-2 py-1 focus:outline-none focus:ring-1 focus:ring-violet-400"
                                    />
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 text-sm border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400 bg-white"
                          />
                          <button
